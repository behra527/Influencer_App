  ...
  const renderCampaignItem = ({ item }) => (
    <View style={styles.campaignBox}>
      ...
      <View style={styles.campaignDetailRow}>
        <MaterialIcons name={item.icon} size={12} color="#667eea" />
        <Text style={styles.campaignDetail}>{item.platform}</Text>
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.opportunitiesSection}>
          ...
          <TouchableOpacity style={styles.viewButtonSecondary}>
          ...
          <View style={styles.linksContainer}>
            <TouchableOpacity style={styles.linkBox}>
              <View style={styles.linkIconContainer}>
                <MaterialIcons name="shopping-basket" size={20} color="#667eea" />
              </View>
              <Text style={styles.linkText}>My Orders</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.linkBox}>
              <View style={styles.linkIconContainer}>
                <MaterialIcons name="headset" size={20} color="#667eea" />
              </View>
        ...
        <View style={styles.activitySection}>
          ...
          <View style={styles.activityItem}>
            ...
            <View style={styles.activityContent}>
              <Text style={styles.activityText}>Your content for "Summer Vibe" was </Text>
              <Text style={styles.activityTextApproved}>approved.</Text>
      ...
      <View style={styles.bottomNav}>
        ...
        <TouchableOpacity style={styles.navItem}>
          <MaterialIcons name="local-offer" size={24} color="#64748b" />
