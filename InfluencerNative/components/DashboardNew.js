...
const DashboardNew = ({ navigation }) => {
  ...
  const handleViewAll = () => {
    // Navigate to featured creators screen or show all featured creators
    alert('Viewing all featured creators...');
    // You can add navigation logic here
    // navigation.navigate('FeaturedCreators');
  };
  ...
  const handleViewProfile = (influencerId) => {
    alert(`Viewing profile of influencer ${influencerId}`);
  };
